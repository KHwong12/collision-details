...
is_valid_serial_no = (is.numeric(params$SELECTED_ACCIDENT_NO) &
                          # use isTRUE to escape from logical(0) if SELECTED_ACCIDENT_NO is NULL
                          isTRUE(params$SELECTED_ACCIDENT_NO >= 1) & isTRUE(params$SELECTED_ACCIDENT_NO <= 95821))
