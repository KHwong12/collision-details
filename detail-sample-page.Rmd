...
is_incorrect_serial_no = params$SELECTED_ACCIDENT_NO < 1 | params$SELECTED_ACCIDENT_NO > 95821

if (is_incorrect_serial_no) {
...
## Detail Report of Collision No. `r as.character(params$SELECTED_ACCIDENT_NO)`
